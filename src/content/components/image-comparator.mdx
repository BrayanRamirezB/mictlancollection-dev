...
<div className='flex items-center justify-center mx-auto not-prose'>
  <Alert
    title='Pista'
    content='Arrastra el control deslizante para comparar la apariencia de las dos imágenes 🕵️.'
    type='default'
...
<div className='flex items-center justify-center pt-10 pb-20 not-prose'>
  <ImageComparator
    originalImage='/examples/img-example5.webp'
    modifiedImage='/examples/img-example13.webp'
    client:load
  />
</div>
...
<CustomTable
  items={[
    ...
    },
    {
      ...
      type: 'string',
      default: '--',
      description: 'URL de la imagen modificada.'
    },
    {
      prop: 'height',
      type: 'number',
    ...
    },
    {
      ...
      default: '--',
      description:
        'Texto que se mostrará en la parte izquierda del control deslizante.'
    },
    {
      prop: 'rightText',
      type: 'string',
      default: '--',
      description:
        'Texto que se mostrará en la parte derecha del control deslizante.'
    }
  ]}
  client:load
/>
